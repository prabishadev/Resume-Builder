...
const Resume1 = () => {
  ...
  return (
    ...
    <label className="input-label">
        ...
        <label className="input-label" style={{marginTop:'-20px'}} htmlFor="username">
          Name:
        </label>
        <input
          id="username"
        ...
        <label className="input-label" style={{marginTop:'-20px'}} htmlFor="email">
          Email:
        </label>
        <input
          id="email"
        ...
        />
         <label className="input-label" style={{marginTop:'-20px'}} htmlFor="contact">
          Contact No:
        </label>
        <input
          id="contact"
        ...
        <label className="input-label" htmlFor="web" style={{marginTop:'-20px'}}>
          Web Url:
        </label>
        <input
          id="web"
        ...
        <label className="input-label" htmlFor="address" style={{marginTop:'-20px'}}>
          Address
        </label>
        <textarea
          id="address"
